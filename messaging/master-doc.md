...
I build Plansom because I am, in the words of my ex-wife, *aggressively lazy*. The idea was that I would never do anything twice if I could possibly do it once — and never do the wrong thing hard when I could do the right thing easily. That sounds like a joke, but it's the whole philosophy.

I come from a family of athletes — several Olympic golds in cross-country skiing between them. And the thing about elite athletes is that they are *lazy* in a very specific way. My relatives will never walk the stairs if there's a lift. Sport, at the top, is not about trying harder. You don't win a marathon by trying harder. You win by directing your energy more effectively than anyone else. That instinct — *where is the energy actually going, and is any of it wasted?* — is the lens I've applied to everything.

What's frustrated me my whole career is watching organisations get this exactly backwards. People working extremely hard, stressed out, exhausted — and getting nowhere. I've seen it in companies I've advised, in friends' businesses, and in myself. There's this hustle-culture assumption that the answer is always *more*: push harder, do more, tick more off. It's wrong. If you push yourself to the limit you might get 20% or 40% more out of yourself. You will never get 100x or 1,000x that way. Those numbers only come from getting the *small things* right — from the system, not the effort.

When I looked closely, the pattern was always the same. In most companies, roughly half the work is simply wasted — people pouring themselves into things that don't matter. Information that exists doesn't flow to the people who need it. Bottlenecks sit in plain sight and nobody is honest about them. And the tools we'd all been handed — task trackers — quietly made it worse, because they're built on the assumption that you should *complete everything*. That you should tick off every task. That's not how anything excellent gets built.

So Plansom started as a refusal of that assumption. The belief that there is a *better way to work* — strategy first, not tasks first — and that it could be made into a system anyone could pick up. Not work harder. Work on the right things, find what's actually stuck, and put your energy there.
...
There is a better way to work, and it's the same for one person and for a hundred thousand. It is not *do more*. It is: **decide what you're actually trying to achieve, find the one thing that's truly blocking you, and put your energy only there.**

Task trackers assume you should complete everything. Strategy is the opposite — it's deciding what *not* to do. Success isn't ticking off every task; it's landing the highest-impact one.

Plansom turns that discipline into a system. You set a goal, it helps you surface the real bottleneck, and it prioritises the work — yours and your agents' — against what matters. Then it gives you one honest number for how you're doing.
